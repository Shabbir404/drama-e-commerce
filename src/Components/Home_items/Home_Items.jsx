    ...
    return (
        <div>
            <div className='open-sans-font'>
                <div className="flex justify-between">
                    ...
                    <div>
                        <div className='md:flex md:gap-4 text-xs md:ml-48 mt-7'>
                            ...
                            <p className='text-[#888888]'>Video Games</p>
                        </div>
                    </div>
                    <div className='flex gap-2 text-3xl ml-4  mr-4 text-gray-400 mt-1'>
                ...
                <hr className='ml-38 w-10/12 border-t-2 -mt-[2px] text-gray-300  mb-4' />
                {/* hr end */}
                ...
                <div className='mt-8'>
                    ...
                    <div className='mt-8 w-full'>
                        <div className='md:flex  md:gap-3'>
                            <div className='flex w-full h-full md:w-[340px] md:h-[180px] bg-[#F5F5F5] p-3'>
                    ...
                    <div className='mt-10'>
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className='flex gap-2 text-3xl ml-4 mr-5  text-gray-400 mt-1'>
                                <IoIosArrowDropleft></IoIosArrowDropleft>
                                <IoIosArrowDropright></IoIosArrowDropright>
                            </div>
                        </div>
                        ...
                        {/* hr end */}
                        <div className='md:flex mt-12  md:gap-10'>
                            <div className="relative">
                    ...
                    <div className='md:flex md:gap-2 mt-10 mb-10'>
                        <img className='h-full w-full md:w-[349px] md:h-[299px]' src={playGamesIMG} alt="" />
                        <img className='h-full w-full md:w-[349px] md:h-[299px]' src={nikonCamIMG} alt="" />
                        <img className='h-full w-full md:w-[349px] md:h-[299px]' src={yearphoneIMG} alt="" />
                    </div>
